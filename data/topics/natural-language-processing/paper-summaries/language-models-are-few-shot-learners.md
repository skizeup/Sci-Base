...
### Résultats clés
Les résultats montrent que le modèle GPT-3, grâce à sa taille importante, peut atteindre des performances compétitives avec les meilleures approches d'apprentissage fine-tuning existantes, même lorsqu'il n'a que peu d'exemples pour apprendre. Cela démontre que la mise à l'échelle des modèles de langage peut considérablement améliorer leur capacité à apprendre avec peu d'exemples.
